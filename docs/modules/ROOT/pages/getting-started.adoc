...
- `@opencreek/neo4j-graphql` is the official Neo4j GraphQL Library package, which takes your GraphQL type definitions and generates a schema backed by a Neo4j database for you.
...
[source, bash, indent=0]
----
npm install @opencreek/neo4j-graphql graphql neo4j-driver apollo-server
----
