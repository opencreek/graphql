...
describe("#601", () => {
    ...
    test("Example 1", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE apoc.util.validatePredicate(NOT (any(var1 IN [\\"view\\"] WHERE any(var0 IN $auth.roles WHERE var0 = var1))), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            CALL {
                WITH this
                MATCH (this)-[this2:REQUIRES]->(this3:\`Document\`)
                WHERE apoc.util.validatePredicate(NOT (any(var5 IN [\\"view\\"] WHERE any(var4 IN $auth.roles WHERE var4 = var5))), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
                CALL {
                    WITH this3
                    MATCH (this3:\`Document\`)<-[this6:UPLOADED]-(this7:\`CustomerContact\`)
                    WHERE apoc.util.validatePredicate(NOT (any(var9 IN [\\"view\\"] WHERE any(var8 IN $auth.roles WHERE var8 = var9))), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
