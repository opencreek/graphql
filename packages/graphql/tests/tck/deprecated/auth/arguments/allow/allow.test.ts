...
describe("Cypher Auth Allow", () => {
    ...
    test("Read Node & Protected Field", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE apoc.util.validatePredicate(NOT ((this.id IS NOT NULL AND this.id = $param0)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            WITH *
            WHERE apoc.util.validatePredicate(NOT ((this.id IS NOT NULL AND this.id = $param1)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
    ...
    test("Read Relationship", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                WHERE apoc.util.validatePredicate(NOT ((exists((this1)<-[:HAS_POST]-(:\`User\`)) AND any(this2 IN [(this1)<-[:HAS_POST]-(this2:\`User\`) | this2] WHERE (this2.id IS NOT NULL AND this2.id = $param1)))), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
    ...
    test("Read Relationship & Protected Field", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                WHERE (apoc.util.validatePredicate(NOT ((this2.id IS NOT NULL AND this2.id = $param1)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0]) AND apoc.util.validatePredicate(NOT ((this2.id IS NOT NULL AND this2.id = $param2)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0]))
    ...
    test("Read Two Relationships", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                WITH this
                MATCH (this)-[this0:HAS_POST]->(this1:\`Post\`)
                WHERE (this1.id = $param2 AND apoc.util.validatePredicate(NOT ((exists((this1)<-[:HAS_POST]-(:\`User\`)) AND any(this2 IN [(this1)<-[:HAS_POST]-(this2:\`User\`) | this2] WHERE (this2.id IS NOT NULL AND this2.id = $param3)))), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0]))
                CALL {
                    WITH this1
                    MATCH (this1)-[this3:HAS_COMMENT]->(this4:\`Comment\`)
                    WHERE (this4.id = $param4 AND apoc.util.validatePredicate(NOT ((exists((this4)<-[:HAS_COMMENT]-(:\`User\`)) AND any(this5 IN [(this4)<-[:HAS_COMMENT]-(this5:\`User\`) | this5] WHERE (this5.id IS NOT NULL AND this5.id = $param5)))), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0]))
