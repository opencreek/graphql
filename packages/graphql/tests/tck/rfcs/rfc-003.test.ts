                ...
                expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
                    ...
                    CALL {
                        ...
                        CALL {
                        	...
                        	WHERE apoc.util.validatePredicate(NOT (c = 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDMovie.director required exactly once', [0])
                ...
                expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
                    ...
                    CALL {
                        ...
                        CALL {
                        	...
                        	MATCH (create_this1)<-[create_this1_director_Director_unique:DIRECTED]-(:Director)
                        	WITH count(create_this1_director_Director_unique) as c
                        	WHERE apoc.util.validatePredicate(NOT (c <= 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDMovie.director must be less than or equal to one', [0])
                        	RETURN c AS create_this1_director_Director_unique_ignored
                        }
                        RETURN create_this1
                    }
                        ...
                        CALL {
                            ...
                            CALL {
                                ...
                                CALL {
                                	...
                                	WHERE apoc.util.validatePredicate(NOT (c = 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDDirector.address required exactly once', [0])
                        ...
                        CALL {
                            ...
                            CALL {
                                ...
                                CALL {
                                	...
                                	MATCH (create_this5)-[create_this5_address_Address_unique:HAS_ADDRESS]->(:Address)
                                	WITH count(create_this5_address_Address_unique) as c
                                	WHERE apoc.util.validatePredicate(NOT (c <= 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDDirector.address must be less than or equal to one', [0])
                                	RETURN c AS create_this5_address_Address_unique_ignored
                                }
                                RETURN collect(NULL) AS create_var7
                            }
                    ...
                    test("should add validation when deleting a required relationship", async () => {
                        ...
                        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
                            ...
                            CALL {
                            	...
                            	WHERE apoc.util.validatePredicate(NOT (c <= 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDMovie.coDirector must be less than or equal to one', [0])
