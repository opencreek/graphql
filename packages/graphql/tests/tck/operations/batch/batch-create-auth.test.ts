    ...
    test("nested batch", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                WITH *
                WHERE apoc.util.validatePredicate(NOT ($isAuthenticated = true AND $create_param4 IN $jwt.roles), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
                WITH create_this0
                CALL {
                	WITH create_this0
            ...
            CALL {
                ...
                WHERE apoc.util.validatePredicate(NOT ($isAuthenticated = true AND create_this2.id = coalesce($jwt.sub, $jwtDefault)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
    ...
    test("heterogeneous batch", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
            	...
            	WHERE this3_actors_connect0_node.id = $this3_actors_connect0_node_param0 AND apoc.util.validatePredicate(NOT ($isAuthenticated = true AND this3_actors_connect0_node.id = coalesce($jwt.sub, $jwtDefault)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            	CALL {
            		WITH *
            ...
            CALL {
                ...
                WHERE apoc.util.validatePredicate(NOT ($isAuthenticated = true AND create_this4.id = coalesce($jwt.sub, $jwtDefault)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            ...
            CALL {
                ...
                WHERE apoc.util.validatePredicate(NOT ($isAuthenticated = true AND create_this10.id = coalesce($jwt.sub, $jwtDefault)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            ...
            CALL {
                ...
                WHERE apoc.util.validatePredicate(NOT ($isAuthenticated = true AND create_this16.id = coalesce($jwt.sub, $jwtDefault)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            ...
            CALL {
                ...
                WHERE apoc.util.validatePredicate(NOT ($isAuthenticated = true AND create_this22.id = coalesce($jwt.sub, $jwtDefault)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            ...
            CALL {
                ...
                WHERE apoc.util.validatePredicate(NOT ($isAuthenticated = true AND create_this28.id = coalesce($jwt.sub, $jwtDefault)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
