        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    ...
                    WHERE apoc.util.validatePredicate(NOT ($isAuthenticated = true AND ($jwt.jwtAllowedNamesExample IS NOT NULL AND this1.name = $jwt.jwtAllowedNamesExample)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
                ...
                CALL {
                    WITH *
                    MATCH (this)-[this0:SEARCH]->(this1:Genre)
                    WHERE (this1.name = $param1 AND apoc.util.validatePredicate(NOT ($isAuthenticated = true AND ($jwt.jwtAllowedNamesExample IS NOT NULL AND this1.name = $jwt.jwtAllowedNamesExample)), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0]))
                    WITH this1 { .name, __resolveType: \\"Genre\\", __id: id(this1) } AS this1
                    RETURN this1 AS var2
                    UNION
                    WITH *
