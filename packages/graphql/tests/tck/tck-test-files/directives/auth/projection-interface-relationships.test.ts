...
describe("Auth projections for interface relationship fields", () => {
    ...
    test("Simple Interface Relationship Query for protected type", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL apoc.util.validate(NOT(this_Series.episodes IS NOT NULL AND this_Series.episodes = $this_Series_auth_allow0_episodes), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
