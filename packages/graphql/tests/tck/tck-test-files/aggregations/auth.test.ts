...
describe("Cypher Aggregations with Auth", () => {
    ...
    test("Field Int with auth", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE this.id IS NOT NULL AND this.id = $this_auth_where0_id
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $this_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $imdbRatingInt_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
    ...
    test("Field Float with auth", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE this.id IS NOT NULL AND this.id = $this_auth_where0_id
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $this_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $imdbRatingFloat_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
    ...
    test("Field BigInt with auth", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE this.id IS NOT NULL AND this.id = $this_auth_where0_id
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $this_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $imdbRatingBigInt_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
    ...
    test("Field ID with auth", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE this.id IS NOT NULL AND this.id = $this_auth_where0_id
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $this_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $id_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
    ...
    test("Field String with auth", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE this.id IS NOT NULL AND this.id = $this_auth_where0_id
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $this_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $name_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
    ...
    test("Field DateTime with auth", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            WHERE this.id IS NOT NULL AND this.id = $this_auth_where0_id
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $this_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
            CALL apoc.util.validate(NOT(this.id IS NOT NULL AND this.id = $createdAt_auth_allow0_id), \\"@opencreek/neo4j-graphql/FORBIDDEN\\", [0])
