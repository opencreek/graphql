    ...
    test("Should have correct variables in apoc.do.when", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
            	...
            	CALL apoc.util.validate(NOT(c = 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDManufacturer.logo required', [0])
            ...
            CALL {
            	...
            	CALL apoc.util.validate(NOT(c = 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDCar.manufacturer required', [0])
            ...
            CALL {
            	...
            	CALL apoc.util.validate(NOT(c = 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDPerson.car required', [0])
