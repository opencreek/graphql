    ...
    test("Should have correct variables in apoc.do.when", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
            	...
            	CALL {
            		...
            		CALL {
            			...
            			WHERE apoc.util.validatePredicate(NOT (c = 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDManufacturer.logo required exactly once', [0])
            	...
            	CALL {
            		...
            		WHERE apoc.util.validatePredicate(NOT (c = 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDCar.manufacturer required exactly once', [0])
            ...
            CALL {
            	...
            	WHERE apoc.util.validatePredicate(NOT (c = 1), '@opencreek/neo4j-graphql/RELATIONSHIP-REQUIREDPerson.car required exactly once', [0])
