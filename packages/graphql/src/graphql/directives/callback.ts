...
const description =
    "NOTE: this directive has been deprecated and will be removed in @opencreek/neo4j-graphql version 4.0.0. " +
    ...
    "Instructs @opencreek/neo4j-graphql to invoke the specified callback function when updating or " +
